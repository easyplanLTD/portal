        ...
        <div className="pt-4" style={{ borderTop: `1px solid ${C.border}` }}>
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <Field label="Scheduled date">
              <input type="date" className={inputCls} style={inputStyle} value={scheduledDate} onChange={(e) => setScheduledDate(e.target.value)} />
            </Field>
            <Field label="Scheduled time">
              <input type="time" className={inputCls} style={{ ...inputStyle, opacity: scheduledDate ? 1 : 0.5 }} value={scheduledTime} onChange={(e) => setScheduledTime(e.target.value)} disabled={!scheduledDate} />
            </Field>
          </div>
