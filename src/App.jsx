        ...
        {tabs.map((t) => {
          ...
          return (
            <button
              ...
              onClick={() => setActive(t.key)}
              className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold"
              style={{ background: isActive ? C.primary : "rgba(255,255,255,0.07)", color: isActive ? C.sidebar : C.mid }}
            >
              {t.label}
              <span
                className="rounded-full px-1.5 text-[11px] font-bold"
                style={{ background: isActive ? "rgba(0,0,0,0.15)" : "rgba(255,255,255,0.09)", color: isActive ? C.sidebar : C.light }}
              >
                {t.items.length}
              </span>
            </button>
